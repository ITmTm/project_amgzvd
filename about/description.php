  ...
  <div class="container">
    <div class="row g-3 align-items-center mb-4">
      <div class="col-lg col-12 order-lg-1 order-2 d-flex flex-column">
        ...
        <div>
          <a href="/assets/files/presentation-amega.pdf" target="_blank" class="btn btn-outline-danger btn-outline-brand-red">Ассортиментная матрица <img src="/imgs/icons/download-black.svg" alt=""></a>
        </div>
      </div>
    ...
    <div class="row g-3 align-items-center mb-4">
      <div class="col-lg col-12 order-lg-1 order-2 d-flex flex-column">
        ...
        <div class="mb-4">«Амега» – это обширная сеть логистики. Доставка в 8 регионов России. Поставки осуществляются в тентовом транспорте со 100% упаковкой изделий. Мы располагаем сетью распределительных центров в Перми, Екатеринбурге, Уфе, Казани, Ижевске, благодаря которым осуществляется адресная доставка до потребителя.</div>
      </div>
      <div class="col-lg-4 col-12 order-lg-2 order-1">
